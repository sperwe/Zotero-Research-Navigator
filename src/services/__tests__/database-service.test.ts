...
describe("DatabaseService", () => {
  ...
  describe("execute", () => {
    ...
    it("should handle execution errors", async () => {
      ...
      await expect(dbService.execute("SELECT * FROM test")).rejects.toThrow(
        "DB Error",
      );
  ...
  describe("transaction", () => {
    ...
    it("should rollback transaction on error", async () => {
      ...
      await expect(dbService.transaction(operations)).rejects.toThrow(
        "Transaction Error",
      );
  ...
  describe("getValue", () => {
    ...
    it("should return null for no results", async () => {
      ...
      const value = await dbService.getValue(
