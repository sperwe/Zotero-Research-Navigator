...
console.log('Option 1: If it returns the actual global globalThis, then _globalThis !== ctx');
...
console.log('3. But basicTool.getGlobal("globalThis") might return the REAL globalThis');
...
console.log('1. The current execution context (this or arguments.callee.caller...)');
