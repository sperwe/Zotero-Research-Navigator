...
describe("MainPanel", () => {
  ...
  describe("Panel Creation", () => {
    it("should create panel container", async () => {
      const container = mockWindow.document.getElementById(
  ...
  describe("Tab Switching", () => {
    it("should switch tabs when clicking tab button", async () => {
      const historyTab = mockWindow.document.querySelector(
        '[data-tab-id="history"]',
      );
      const notesTab = mockWindow.document.querySelector(
        '[data-tab-id="notes"]',
      );
    ...
    it("should show corresponding content when switching tabs", async () => {
      ...
      const notesContent =
        mockWindow.document.querySelector('[data-tab="notes"]');
  ...
  describe("Window Controls", () => {
    it("should minimize panel when clicking minimize button", () => {
      const minimizeBtn = mockWindow.document.querySelector(
    ...
    it("should close panel when clicking close button", () => {
      const closeBtn = mockWindow.document.querySelector(
