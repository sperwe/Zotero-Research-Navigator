 ...
 * 创建分隔符
 */
export function createSeparator(doc: Document, type: "horizontal" | "vertical" = "horizontal"): Element {
  ...
  return createElement(doc, "hr", {
    styles: {
      ...
      border: "none",
      borderTop: type === "horizontal" ? "1px solid var(--material-border, #e0e0e0)" : "none",
      borderLeft: type === "vertical" ? "1px solid var(--material-border, #e0e0e0)" : "none",
...
export function createIconButton(
  ...
  button.addEventListener("mouseenter", () => {
    (button as HTMLElement).style.backgroundColor = "var(--material-background-hover, rgba(0,0,0,0.05))";
  });
