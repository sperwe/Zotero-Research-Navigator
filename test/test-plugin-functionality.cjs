...
async function testPlugin() {
  ...
  if (Zotero.ResearchNavigator) {
    ...
    console.log('- databaseService:', !!Zotero.ResearchNavigator.databaseService);
    console.log('- noteAssociationSystem:', !!Zotero.ResearchNavigator.noteAssociationSystem);
    console.log('- closedTabsManager:', !!Zotero.ResearchNavigator.closedTabsManager);
  }
