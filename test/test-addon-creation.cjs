...
try {
  ...
  console.log('- ctx.addon:', typeof ctx.addon !== 'undefined' ? 'FOUND' : 'NOT FOUND');
  console.log('- ctx.globalThis.addon:', typeof ctx.globalThis?.addon !== 'undefined' ? 'FOUND' : 'NOT FOUND');
  console.log('- ctx.addonInstance:', typeof ctx.addonInstance !== 'undefined' ? 'FOUND' : 'NOT FOUND');
  ...
  Object.keys(ctx).forEach(key => {
    if (!['Zotero', 'Services', 'ChromeUtils', 'Components', 'console', 'globalThis'].includes(key)) {
