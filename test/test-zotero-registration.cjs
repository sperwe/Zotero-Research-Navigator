...
try {
  ...
  console.log(
    `   ctx._globalThis.addon = ${ctx._globalThis?.addon ? "exists" : "undefined"}`,
  );
  ...
  console.log("\n4. Final state:");
  console.log(
    `   Zotero.ResearchNavigator = ${mockZotero.ResearchNavigator ? "SET" : "UNDEFINED"}`,
  );

  // Test what user would see
  console.log("\n5. User console.log test:");
  console.log(
    `   typeof Zotero.ResearchNavigator = ${typeof mockZotero.ResearchNavigator}`,
  );
